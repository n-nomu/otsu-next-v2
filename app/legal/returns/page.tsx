          ...
          <div className="prose prose-lg max-w-none text-[#1A1A1A] space-y-8">
            ...
            <section>
              ...
              <ul className="list-disc pl-6 mt-2 space-y-2">
                ...
                <li>We will provide a prepaid shipping label for the return</li>
              </ul>
            </section>
            ...
            <section>
              ...
              <p>
                This policy works alongside your statutory rights under the UK Consumer Rights Act 2015. Handcrafted, one-of-a-kind artworks are understood to be unique creations, but your right to receive goods as described remains fully protected.
              </p>
            </section>
            ...
            <section className="border-t border-[#1A1A1A]/10 pt-8 mt-12">
              ...
              <p className="mt-2">
                ...
                Contact: <a href="mailto:info@bizen-london.com" className="text-[#B8735A] hover:underline">info@bizen-london.com</a>
              </p>
            </section>
          </div>
        </div>
